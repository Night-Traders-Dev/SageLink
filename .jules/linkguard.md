...
- **Insecure Default Permissions:** File creation with default permissions followed by a `chmod` creates a race condition (TOCTOU) for sensitive files (e.g., `identity.key` generated by `keygen`).
